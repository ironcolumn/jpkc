...
/**
 * An abstract class for storing GoJS <a href="http://gojs.net/latest/api/symbols/Diagram.html">Diagram</a> 
 * <a href="http://gojs.net/latest/api/symbols/Model.html">models</a> in various cloud storage services.
...
export class GoCloudStorage {
    ...
    */
    ...
    /** 
     * Get / set the GoJS <a href="http://gojs.net/latest/api/symbols/Diagram.html">Diagram</a>s associated with this instance of GoCloudStorage. 
